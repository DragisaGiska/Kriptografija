...
namespace CryptographyProject.View
{
    public partial class Main : Form
    {
        ...
        public void Ended()
        {
            txtNumberAciveThreads.Text = LoadedFilesController.numberActiveThreads.ToString();
            txtTime.Text = " ";

            txtTime.Text = LoadedFilesController.dateandtime.ToString();
            //Model
        ...
        private void threadsNumber_ValueChanged(object sender, EventArgs e)
        {
            ...
            if ((int)threadsNumber.Value <= numberOfThreads)
            {
        ...
        //Ispisivanje koliko tredova podrzava ovaj procesor
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            txtNumberThreads.Text = coreCount.ToString();
            numberOfThreads = coreCount;
        }
        ...
        private void logView_SelectedIndexChanged(object sender, EventArgs e)
        {
